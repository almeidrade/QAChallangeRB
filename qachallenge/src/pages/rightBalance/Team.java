...
public class Team {
	...
	public static WebElement getPageWebElement(String screenDisplayedText) throws InterruptedException {
		...
		case "START NOW":
			return Helpers.getsWebElement(Footers.btnStartNow(), DEFAULT_TIMEOUT_SECONDS);
		//...
		//...	
		default:
	...
	public static void validateTxtMessage(String expectedScreenDisplayedText) throws Throwable {
		...
		case "HELPING TECHNOLOGY LEADERS EVOLVE HUMANKIND":
			...
			break;
		case "START NOW":
			assertEquals(expectedScreenDisplayedText, Helpers.GetText(Footers.btnStartNow(), DEFAULT_TIMEOUT_SECONDS));
			break;
		//...
		//...
		default:
